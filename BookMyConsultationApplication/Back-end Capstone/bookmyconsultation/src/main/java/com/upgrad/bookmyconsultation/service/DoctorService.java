...
public class DoctorService {
	...
	public Doctor register(Doctor doctor) throws InvalidInputException{
		...
		if(doctor.getAddress() == null){
			throw new InvalidInputException((List<String>) doctor.getAddress());
		}
		...
		responseAddress = doctor.getAddress();
		Address savedAddress = addressRepository.save(responseAddress);
