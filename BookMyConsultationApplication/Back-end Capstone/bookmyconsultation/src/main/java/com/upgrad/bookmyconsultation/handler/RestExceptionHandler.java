...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity handleSlotUnavailableException(SlotUnavailableException e, WebRequest req){
		List<String> errorDetails = new ArrayList<String>();
		errorDetails.add(e.getLocalizedMessage());
//		ErrorResponse errorResponse = new ErrorResponse();
//		return ResponseEntity.badRequest().body(new ErrorResponse(HttpStatus.BAD_REQUEST, e.getDescription()));
